...
import { PackingList, ListItem, UserProfile } from './types';
import { 
  Plus, 
  Search, 
  LogOut, 
      ...
      <div className="flex-1 bg-stone-900 text-white p-12 flex flex-col justify-between relative overflow-hidden">
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-12">
            ...
            <span className="text-2xl font-medium tracking-tight">Pakkelisten</span>
          </div>
      ...
      <div className="flex-1 bg-white p-12 flex items-center justify-center">
        <div className="max-w-sm w-full">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <Button variant="secondary" onClick={() => signInWithGoogle()} className="py-3">
...
function Header({ user, onGoHome }: { user: any, onGoHome: () => void }) {
  return (
    <header className="flex items-center justify-between mb-12">
      ...
      >
        ...
        <div>
          <h1 className="text-xl font-medium tracking-tight">Pakkelisten</h1>
